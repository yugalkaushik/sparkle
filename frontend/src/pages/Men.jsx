...
const Men = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const filteredProducts = response.data.filter(product => product.gender === 'Male');
  ...
  return (
    <div className='bg-gray-100 p-4 sm:p-6 md:p-8 lg:p-10 mt-24 md:mt-6 lg:mt-[3.5rem]'>
      <h1 className="font-orbitron text-2xl sm:text-3xl md:text-4xl lg:text-3xl mb-4">Men</h1>
