...
const Footer = () => {
  return (
    <footer className="bg-white mr-8 mb-24 ml-8 mt-24 relative">
      <div className="container mx-auto flex flex-row items-center justify-between">
        <div className="flex flex-row justify-center sm:w-2/3 lg:w-1/3 mt-4 ">
      ...
      <div className="text-center mt-4">
        <p className="text-sm">&copy; {new Date().getFullYear()} Sparkle. All rights reserved.</p>
